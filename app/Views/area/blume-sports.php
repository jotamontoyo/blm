...
<?= $this->section('contenido'); ?>
    ...
    <div class="cabecera" style="background-image: url('<?= base_url(); ?>public/img/fondos/blume/area-blume.jpg')">
            ...
            <div class="container-fluid banner px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center py-5 shadow-lg">
                  <div class="col-12 col-sm-8 col-lg-6 text-center">
                    <video id="video-fitness" src="<?= base_url(); ?>public/videos/video-fitness.mp4" autoplay controls></video>
                  </div>
                  <div class="col-lg-6">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                      <div class="botones_banner"><a id="boton-reproducir-fitness" class="btn btn-primary sombra">Ver video</a></div>
                    </div>
                  </div>
                </div>
                <script>
                  $(document).ready(function () {
                    $(document).on('click','#boton-reproducir-fitness',function() {
                      var video = document.getElementById('video-fitness');
                      video.play();
                    });
                  });
                </script>
