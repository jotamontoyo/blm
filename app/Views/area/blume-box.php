            ...
            <div class="container-fluid banner px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center py-5 shadow-lg">
                  <div class="col-12 col-sm-8 col-lg-6 text-center">
                    <video id="video-box" src="<?= base_url(); ?>public/videos/video-box.mp4" autoplay controls></video>
                  </div>
                  <div class="col-lg-6">
                    <h3 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Blume Box</h3>
                    <p class="lead">Conoce nuestra sala box, una sala dotada con maquinas de calidad, variedad de agarras y pesos libres para que puedas realizar las rutinas más completas, siempre acompañado por uno de nuestro monitores capacitados.</p>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                      <div class="botones_banner"><a id="boton-reproducir-box" class="btn btn-primary sombra">Ver video</a></div>
                    </div>
                  </div>
                </div>
                <script>
                  $(document).ready(function () {
                    $(document).on('click','#boton-reproducir-box',function() {
