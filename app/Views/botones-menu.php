<div class="botones_menu">
    ...
    <li class="nav-item" id="dropdown">
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="<?= base_url(); ?>horarios/blume" style="background-color: white;"> Blume</a></li>
        <li><a class="dropdown-item" href="<?= base_url(); ?>horarios/box" style="background-color: white;"> Box</a></li>
      </ul>
    </li>
</div>
