...
<body class="d-flex flex-column h-100" >
    ...
    <footer class="py-3 my-4">
        <p class="text-center text-body-secondary">&copy; 2024 Gimnasio Blume <img src="<?= base_url(); ?>public/img/fondos/bandera_nicaragua.png" style="max-width: 30px; display:inline-block;" alt=""></p>
